...
public class HelperView {
    ...
    public static View inflate(LayoutInflater layoutInflater, int layout) {
        View view;
    ...
    public static View inflate(Context context, int layout, ViewGroup container) {
        View view;
    ...
    public static View inflate(LayoutInflater layoutInflater, int layout, ViewGroup container) {
        View view;
